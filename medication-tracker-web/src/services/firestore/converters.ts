...
export const medicationRequestConverter = {
  toFirestore: (medReq: MedicationRequestDocument): Record<string, any> => {
    return {
      ...
      updatedAt: serverTimestamp(),
      createdAt: medReq.createdAt || serverTimestamp(),
    };
  },
...
export const medicationAdministrationConverter = {
  toFirestore: (medAdmin: MedicationAdministrationDocument): Record<string, any> => {
    return {
      ...
      effectiveDateTime: medAdmin.effectiveDateTime || serverTimestamp(),
      effectivePeriod: medAdmin.effectivePeriod || undefined,
      performer: medAdmin.performer || [],
      administrationStatus: medAdmin.administrationStatus || undefined,
      scheduledTime:
        medAdmin.scheduledTime === undefined ? undefined : medAdmin.scheduledTime,
      actualTime: medAdmin.actualTime || medAdmin.effectiveDateTime || serverTimestamp(),
      performedBy: medAdmin.performedBy,
      performedByRole: medAdmin.performedByRole,
      performedByName: medAdmin.performedByName || null,
      isEdited: medAdmin.isEdited ?? false,
      editHistory: medAdmin.editHistory || [],
      ...
      updatedAt: serverTimestamp(),
      createdAt: medAdmin.createdAt || serverTimestamp(),
    };
  },
  ...
  fromFirestore: (
    ...
    return {
      ...
      administrationStatus: data.administrationStatus,
      scheduledTime: data.scheduledTime,
      actualTime: data.actualTime || data.effectiveDateTime,
...
export const relatedPersonConverter = {
  toFirestore: (relatedPerson: RelatedPersonDocument): Record<string, any> => {
    return {
      ...
      updatedAt: serverTimestamp(),
      createdAt: relatedPerson.createdAt || serverTimestamp(),
    };
  },
...
export const careTeamConverter = {
  toFirestore: (careTeam: CareTeamDocument): Record<string, any> => {
    return {
      ...
      updatedAt: serverTimestamp(),
      createdAt: careTeam.createdAt || serverTimestamp(),
    };
  },
...
export const familyConnectionConverter = {
  toFirestore: (connection: FamilyConnection): Record<string, any> => {
    return {
      ...
      caregiverEmail: connection.caregiverEmail,
      caregiverEmailLowercase:
        connection.caregiverEmailLowercase || connection.caregiverEmail.toLowerCase(),
  ...
  fromFirestore: (snapshot: DocumentSnapshot | QueryDocumentSnapshot): FamilyConnection => {
    ...
    return {
      ...
      caregiverEmailLowercase: data.caregiverEmailLowercase,
      patientId: data.patientId,
      status: data.status,
